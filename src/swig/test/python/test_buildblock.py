...
def test_Vector():
    ...
    # this behaviour is the same as for a Python list, but is different from
    # C++
    dvcopy[2] = 4
...
def test_Array2D():
    a2 = FloatArray2D(IndexRange2D(Int2BasicCoordinate(
        (3, 3)), Int2BasicCoordinate((9, 9))))
    a2.fill(2)
    ...
    # a2[4]=a1
    # print 'now the entry in the 2D array has to be modified to 66 as well:',
    # a2[Int2BasicCoordinate((4,5))]
